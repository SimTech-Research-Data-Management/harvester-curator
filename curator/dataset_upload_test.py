...
def dataset_upload(curated_metadata_file: str, server_url: str, api_token: str, dataverse_id: str) -> None:
    """
    ...
    if exists(curated_metadata_file) and getsize(curated_metadata_file) > 0:
        # Open the JSON file for reading
        with open(curated_metadata_file, 'r') as json_file:
    ...
    if citation_metadata:
        ...
        if not missing_fields:
            ...
            #Currently the uploading of metadata only works without codeMeta20 metablock due to the occurance of 
            #       "TypeError: Object of type Url is not JSON serializable" when codeMeta20 exists
            # The following three lines should be removed if the uploading works for codeMeta20 
        ...
        print("Missing citation metablock in dataset metadata")
